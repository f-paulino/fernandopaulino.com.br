<div class="col-md-9 col-md-offset-3" id="conteudo">
    <div class="col-md-12">
        ...
        <?php
            ...
            try {
                $stmt = $db->query("SELECT postID, postTitle, postImg, postUrlTitle, postCat, postSubCat, postDesc, postDate FROM blog_posts ORDER BY postID DESC limit $start, $limit");
            ...
            echo '
            <div class="col-md-5 col-md-offset-1 unidade-artigo un-cat_'.$postUrlCat.'">
                ...
                <p>'; echo substr($row['postDesc'], 0, 124); echo'...</p>
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        if(isset($pag)){
                            ...
                            else { echo "<li><a href='ultimos-artigos&part=".$i."'>".$i."</a></li>"; }
                            }
                            echo "</ul>";
                        }
                    ?>
