    ...
    <div class="col-md-12">
        <div class="row" id="topo-categoria">
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    <h2><i class="material-icons red">&#xE892;</i>&nbsp; Design </h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            try {
                $stmt = $db->query("SELECT postID, postTitle, postImg, postUrlTitle, postCat, postSubCat, postDesc, postDate FROM blog_posts WHERE postCat like 'Design' ORDER BY postID DESC limit $start, $limit");
            ...
            <div class="col-md-5 col-md-offset-1 unidade-artigo">
                <div class="row thumbnail-artigo">
                    <a href="artigo&assunto='.$postUrlCat.'&titulo='.$row['postUrlTitle'].'"><img src="img/uploaded/articles/'.$row['postImg'].'"></a>
                </div>
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        if(isset($pag)){
                            ...
                            else { echo "<li><a href='design&part=".$i."'>".$i."</a></li>"; }
                            }
                            echo "</ul>";
                        }
                    ?>
...
<style type="text/css">#mn2 li i{color: #d04545!important;}</style>