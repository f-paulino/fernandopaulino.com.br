    ...
    <div class="col-md-12">
        <div class="row" id="topo-categoria">
            <div class="col-md-10 col-md-offset-1">
                <div class="row">
                    <h2><i class="material-icons blue">&#xE892;</i>&nbsp; Desenvolvimento Web </h2>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            try {
                $stmt = $db->query("SELECT postID, postTitle, postImg, postUrlTitle, postCat, postSubCat, postDesc, postDate FROM blog_posts WHERE postCat like 'Desenvolvimento web' ORDER BY postID DESC limit $start, $limit");
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        if(isset($pag)){
                            ...
                            else { echo "<li><a href='desenvolvimento-web&part=".$i."'>".$i."</a></li>"; }
                            }
                            echo "</ul>";
                        }
                    ?>
...
<style type="text/css">#mn3 li i{color: #4590d0!important;}</style>